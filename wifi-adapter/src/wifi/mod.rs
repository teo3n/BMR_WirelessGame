...
//#[link(name = "mesh", kind="static")]
#[link(name = "net80211", kind="static")]
#[link(name = "phy", kind="static")]
#[link(name = "pp", kind="static")]
#[link(name = "pwm", kind="static")]
#[link(name = "smartconfig", kind="static")]
#[link(name = "ssl", kind="static")]
//#[link(name = "upgrade", kind="static")]
//#[link(name = "wpa", kind="static")]
#[link(name = "wpa2", kind="static")]
//#[link(name = "wps", kind="static")]
extern "C" {
